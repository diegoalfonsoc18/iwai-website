...
const equipo = [
  ...
  },
  {
    ...
    especialidad:
      "Gobernanza Pública, Transformación Institucional y Gestión Estratégica del Cambio",
    pais: "Colombia",
  ...
  },
  {
    ...
    especialidad:
      "Gobernanza Laboral, Diálogo Social y Relaciones Institucionales Internacionales",
    pais: "Colombia",
    bandera: "/colombia.webp",
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="flex flex-col gap-6">
              <p className="text-dark/70 text-base leading-relaxed border-l-2 border-lima/40 pl-5">
                Nuestro trabajo nace de la experiencia acumulada de un equipo
                profesional que ha vivido y gestionado contextos
                organizacionales exigentes, dinámicos y complejos. Conocemos las
                tensiones reales que enfrentan las organizaciones por cambios
                normativos, dinámicas humanas, estructurales y estratégicas, y
                entendemos que las soluciones solo funcionan cuando integran
                todas estas dimensiones.
              </p>

              <p className="text-dark/70 text-base leading-relaxed border-l-2 border-lima/40 pl-5">
                Nuestro compromiso va más allá de la recomendación: nos
                involucramos activamente para acompañar procesos que requieren
                seriedad, rigor metodológico y sensibilidad humana.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-dark py-24 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-white text-lg lg:text-xl leading-relaxed font-medium">
              El Grupo Estratégico se fortalece con la participación de
              profesionales con trayectorias sólidas en distintos campos
              especializados, incluyendo el ámbito jurídico, el análisis
              actuarial y enfoques interdisciplinarios relacionados con el
              bienestar organizacional y la seguridad y salud en el trabajo.{" "}
              <span className="text-lima">
                Esta diversidad permite ampliar la mirada y abordar los desafíos
                institucionales desde diferentes niveles de análisis, integrando
                perspectivas estratégicas, técnicas y humanas según las
