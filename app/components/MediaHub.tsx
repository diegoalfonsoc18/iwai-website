        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <span className="text-dark/40 text-xs font-medium">{podcasts[0].ep}</span>
            </div>
            <div>
          ...
          <div className="md:col-span-1 md:row-span-2 rounded-3xl overflow-hidden relative min-h-[320px]">
            <Image src={fotos[0].src} alt={fotos[0].alt} fill className="object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-dark/80 via-transparent to-transparent" />
            <div className="absolute bottom-0 left-0 right-0 p-6">
              <span className="text-xs font-semibold text-white/50 tracking-widest uppercase">Fotos</span>
              <p className="text-white font-semibold mt-1">{fotos[0].alt}</p>
            </div>
          </div>

          {/* ③ Episodio 2 */}
          <a href={podcasts[1].href} className="group bg-white/5 border border-white/10 rounded-3xl p-6 flex flex-col gap-4 hover:border-lima/30 transition-colors">
            <div className="flex items-center justify-between">
            ...
            <p className="text-white text-sm font-semibold leading-snug flex-1">{podcasts[1].titulo}</p>
            <div className="flex items-center justify-between">
          ...
          {/* ④ Episodio 3 */}
          <a href={podcasts[2].href} className="group bg-white/5 border border-white/10 rounded-3xl p-6 flex flex-col gap-4 hover:border-lima/30 transition-colors">
            <div className="flex items-center justify-between">
              <span className="flex items-center gap-1.5 text-lima text-xs font-bold">
                <PodcastIcon />
                {podcasts[2].ep}
            ...
            <p className="text-white text-sm font-semibold leading-snug flex-1">{podcasts[2].titulo}</p>
            <div className="flex items-center justify-between">
              <div className="w-8 h-8 bg-lima/10 rounded-full flex items-center justify-center text-lima group-hover:bg-lima group-hover:text-dark transition-all">
                <PlayIcon />
              </div>
          ...
          <div className="rounded-3xl overflow-hidden relative min-h-[180px]">
            <Image src={fotos[1].src} alt={fotos[1].alt} fill className="object-cover" />
          ...
          {/* ⑥ Foto 3 */}
          <div className="rounded-3xl overflow-hidden relative min-h-[180px]">
            <Image src={fotos[2].src} alt={fotos[2].alt} fill className="object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-dark/70 via-transparent to-transparent" />
            <div className="absolute bottom-0 left-0 right-0 p-5">
          ...
          {/* ⑦ CTA ver todo */}
          <a href="#" className="group bg-white/5 border border-white/10 rounded-3xl p-6 flex flex-col items-center justify-center gap-3 min-h-[180px] hover:border-lima/30 transition-all text-center">
