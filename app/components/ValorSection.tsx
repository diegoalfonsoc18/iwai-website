...
const items = [
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path
          d="M11 3v4M11 15v4M3 11h4M15 11h4M5.64 5.64l2.83 2.83M13.54 13.54l2.82 2.82M16.36 5.64l-2.82 2.83M8.46 13.54l-2.83 2.82"
          stroke="#0F0F0F"
          strokeWidth="1.8"
          strokeLinecap="round"
        />
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-muted leading-relaxed">
            Acompañamos a organizaciones públicas y privadas que enfrentan
            desafíos complejos y requieren más que asesoría técnica tradicional;
            entendemos que necesitan aliados estratégicos capaces de comprender
            su realidad institucional, laboral y humana, y transformar esa
            comprensión en soluciones concretas que generen resultados.
          </p>
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="relative w-full max-w-sm">
              ...
              <div className="relative z-10 flex flex-col gap-6">
                ...
                <div className="flex gap-3 mb-8">
                  {[
                    ...
                    <div
                      key={loc.pais}
                      className="flex items-center gap-2 bg-dark/10 rounded-2xl px-3 py-2.5 flex-1">
                      <Image
                        src={loc.src}
                        alt={loc.pais}
                        width={22}
            ...
            <a
              href="/contacto"
              className="absolute -bottom-5 -left-5 bg-white rounded-2xl shadow-xl px-5 py-4 flex items-center gap-3 hover:shadow-2xl transition-shadow">
